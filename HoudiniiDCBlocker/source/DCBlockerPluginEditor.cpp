...
DCBlockerPluginEditor::DCBlockerPluginEditor(DCBlockerPluginProcessor& p)
...
DCBlockerPluginEditor::~DCBlockerPluginEditor() = default;

void DCBlockerPluginEditor::paint(juce::Graphics& g)
{
...
void DCBlockerPluginEditor::resized()
{
