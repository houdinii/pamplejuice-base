...
DistortPluginEditor::DistortPluginEditor(DistortPluginProcessor& p)
...
DistortPluginEditor::~DistortPluginEditor() = default;

void DistortPluginEditor::paint(juce::Graphics& g)
{
...
void DistortPluginEditor::resized()
{
