...
namespace houdinii
{
    ...
    void GainReductionMeter::paint (juce::Graphics& g)
    {
        ...
        // 0dB mark
        g.drawText ("0", bounds.getRight() - 15, bounds.getY(), 12, bounds.getHeight(), juce::Justification::centred); // NOLINT(*-narrowing-conversions)

        // -10dB mark
        float x10 = bounds.getX() + bounds.getWidth() * 0.5f;
        g.drawText ("-10", x10 - 12, bounds.getY(), 24, bounds.getHeight(), juce::Justification::centred); // NOLINT(*-narrowing-conversions)

        // -20dB mark
        g.drawText ("-20", bounds.getX() + 2, bounds.getY(), 24, bounds.getHeight(), juce::Justification::centred); // NOLINT(*-narrowing-conversions)
    }
