...
namespace houdinii
{
    ...
    void MeterSectionUI::initialize()
    {
        ...
        startTimerHz (24); // 24 Hz update rate using JUCE's helper method
    }

    void MeterSectionUI::layoutControls (juce::Rectangle<int> area)
    {
        constexpr int meterWidth = 25; // Slightly narrower meters
        constexpr int meterSpacing = 5;
        constexpr int labelHeight = 12; // Smaller labels
